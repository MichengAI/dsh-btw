...
const allowed = /^(?:package\/(?:lib\/|assets\/screenshots\/|docs\/)|package\/(?:package\.json|cordis\.patch\.yml|README\.md|CHANGELOG(?:\.zh-CN)?\.md|LICENSE)$)/
...
for (const required of ['lib/index.js', 'lib/client.js', 'lib/types/index.d.ts', 'cordis.patch.yml', 'README.md', 'CHANGELOG.md', 'CHANGELOG.zh-CN.md', 'assets/screenshots/btw-command-menu.png', 'assets/screenshots/btw-bubbles.png', 'assets/screenshots/btw-conversation.png']) {
